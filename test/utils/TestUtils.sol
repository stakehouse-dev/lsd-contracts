...
contract TestUtils is Test {
    ...
    bytes blsPubKeyFive = fromHex("aa44b24a1498bf1a93aaca796a1eed603d6698b4fcfdc6ef653322ff703432200befa65d11211bc89815c17cd8ea260d");
    ...
    function getBytesArrayFromBytes(bytes memory data, bytes memory data2, bytes memory data3, bytes memory data4) public pure returns (bytes[] memory) {
        bytes[] memory array = new bytes[](4);
        array[0] = data;
        array[1] = data2;
        array[2] = data3;
        array[3] = data4;
